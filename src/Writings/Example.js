  ...
  return (
    <>
      {/* <p>
        ...
        ea”Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
        eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
        minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip
        ex ea”
      </p>
      <img src="images/projects/circle.jpg" />
      <p>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
        veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea”
...
<h3>Pain points from our four panelists</h3>
<p>Affinity Diagramming<br />
After thinking through the pain points, we moved on to the convergence process where we try to identify and prioritize which problems to solve. In order to achieve that, we first used affinity diagramming to put our research in context and in relation to each other.</p>

<h3>A photo of our affinity diagramming process</h3>
...
<h3>Sketches for potential features</h3>
<p>Paper Sketches<br />
Taking all of our ideas into consideration, we decided to focus on four specific values that are bolded below:</p>

<ul>
  <li><strong>Ability to customize the device</strong></li>
  <li><strong>Easy editing and programming sentences</strong></li>
  <li><strong>Having the option to express the wait time for a person to compose a sentence</strong></li>
  <li><strong>Ability to save previous conversations for easy access</strong></li>
  <li>Responsive UI on different devices</li>
  <li>More natural voices</li>
  <li>Visual disability-friendly options</li>
  <li>Easier access to specific words</li>
...
<h3>Our paper sketches for screens</h3>
<p>Our paper sketches — including the homepage, profile, and history screens<br />
Hi-fi Prototyping<br />
With our time constraint, we moved on to mock up a high-fidelity version of our sketches, keeping in mind that our sketches could have been tested and improved. Here is the hi-fi prototype of our device:</p>

<p>The homepage includes different categories of words, allowing easier access to specific words. Additionally, we also included a “Wait!” button that triggers blinking lights from the device, signaling the other interlocutor to wait.<br />
A gif showing our hi-fi prototype for the category feature<br />
Homepage with categories, access to history and wait buttons<br />
The profile page allows customizing categories as well as app colors and icons.<br />
A gif showing our hi-fi prototype for the customization feature<br />
Profile page with customizations<br />
Finally, we added a feature for saving recent conversations. This allows users to access the conversation that they saved and have the device speak a full sentence without retyping.<br />
A gif showing our hi-fi prototype for the conversation history feature<br />
History page with access to saved conversations<br />
The Figma link for our project can be found here.</p>
...
<p>Credit to <a href="https://icons8.com/">Icons8</a> for our lovely icons!<br />
</p>
