...
<img src="images/projects/hci.jpg" alt="Hi-fi prototype for an AAC device on a tablet" />
      ...
      <img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*qZaEy3_t1hMBsnAOo2Oc4g.png" alt="Image depicting our design process" />
      ...
      <img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*r1vhdvJPPZxJC-lXP1Fevg.jpeg" alt="Chart of values and value tensions for stakeholders" />
      ...
      <img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*Twbv_9NYDWarFg1LXQsWMg.png" alt="Pain points from our four panelists" />
      ...
      <img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*_j3fs5-gz7lQ1ZdNcK8yzQ.png" alt="Affinity diagramming" />
      ...
      <img src="https://miro.medium.com/v2/resize:fit:750/format:webp/1*O9zIRfsTstwRnJCjsLWThg.png" alt="Sketches for potential features" />
      ...
      <img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*9YYbeaIFcI1lRZNoO0kIGg.png" alt="Our paper sketches — including the homepage, profile, and history screens" />
      ...
      <img src="https://miro.medium.com/v2/resize:fit:828/format:webp/1*OquloEAKLl7td5M9kx8RgQ.gif" alt="Homepage with categories, access to history and wait buttons" />
      ...
      <img src="https://miro.medium.com/v2/resize:fit:828/format:webp/1*Fd3PWI_JzXYOm6Bu3j8rlg.gif" alt="Profile page with customizations" />
      ...
      <img src="https://miro.medium.com/v2/resize:fit:828/format:webp/1*LnPqe6HuR_HIAetDgCZPNA.gif" alt="History page with access to saved conversations" />
      <p>History page with access to saved conversations</p>
      
      <p>The Figma link for our project can be found <a href="https://example.com" target="_blank" rel="noopener noreferrer">here</a>.</p>
      ...
      <img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*lrwFN75HQcbza8vdV0Rqew.png" alt="Storyboarding" />
      <p>Storyboarding</p>
      ...
      <p>Credit to <a href="https://icons8.com/" target="_blank" rel="noopener noreferrer">icons8.com</a> for our lovely icons!</p>
